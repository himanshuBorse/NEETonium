...
<div class="row mx-5 text-center">
    ...
    <div class="mx-5 mt-5 text-center">
        <!--table-->
        <p class="bg-danger text-white p-2"> Incorrect Attempts</p>
        <?php
        $sql = "SELECT * FROM mcq INNER JOIN incorrectattempt ON mcq.mcq_id=incorrectattempt.mcq_id WHERE incorrectattempt.stu_id ='".$stuLogID."' ";
        $result = $conn->query($sql);
        ...
        <?php 
            ...
            echo '<input type="submit" class="btn btn-danger" value="Attempt Now."></input>';
            echo '</form>';
        } ?>
    </div>
</div>
