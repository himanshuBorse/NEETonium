...
include_once "../resources/mainInclude/dbConnection.php";

//Checking emial already registered
...
if(!isset($_SESSION['is_login'])){
  if(isset($_POST['checkLogemail']) && isset($_POST['stuLogEmail'])  && isset($_POST['stuLogPass'])){
      ...
      $sql = "SELECT stu_id,stu_email, stu_pass FROM  student WHERE stu_email ='".$stuLogEmail."'  AND stu_pass= '".$stuLogPass."' ";
