 ...
 <div class="col-sm-9 mt-5">
   <!-- <div class="row mx-5 text-center">
    ...
    <div class="mx-5 mt-5 text-center">
        <!--table-->
        <p class="bg-warning text-dark font-weight-bold p-2"> Reported Question</p>
        <?php
          $sql = "SELECT * FROM mcq INNER JOIN questionreport ON mcq.mcq_id=questionreport.mcq_id WHERE mcq.stu_id ='".$stuLogID."' ";
        $result = $conn->query($sql);
